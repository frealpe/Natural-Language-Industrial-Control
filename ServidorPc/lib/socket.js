...
class Sockets {
  ...
  socketEvents() {
    this.io.on('connection', (socket) => {
      ...
      // 🔹 Retransmitir Comparación
      socket.on('comparacion', (msg) => {
          this.enviarMensaje('comparacion', msg);
      });

      // 🔹 Retransmitir Caracterización
      socket.on('caracterizacion', (msg) => {
          this.enviarMensaje('caracterizacion', msg);
      });
